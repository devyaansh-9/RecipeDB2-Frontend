...
async function run() {
  console.log("Sleeping 40 seconds to clear rate limit...");
  await new Promise(r => setTimeout(r, 40000));
  
  const paths = [
    '/recipe2-api/recipeByTitle/Lentil?page=1&page_size=5',
    '/recipe2-api/recipe/recipeByTitle/Lentil?page=1&page_size=5',
    '/recipe2-api/recipes-by-carbs?carbs=30&page=1&page_size=5',
    '/recipe2-api/recipe/recipesByTitle/Lentil?page=1&page_size=5'
  ];
